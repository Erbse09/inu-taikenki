...
('showtech-duopin-undercoat','ブラッシングが苦手な犬',NULL,NULL,'scared long-pin','長めのピンで被毛へ入りやすく、ブラッシングが苦手な犬にも以前よりやさしく当てやすそうと感じた体験。','public_buyer_review_summary','https://shopping.yahoo.co.jp/review/item/list?page_key=tr25se007&store_id=freebirdcorp'),
...
('furminator-deshedding','ポメラニアン',NULL,'long double','relaxed genuine','安価な類似品から正規品へ替えたところ、犬が気持ちよさそうにブラッシングを受け、使用感の違いを感じた体験。','public_buyer_review_summary','https://shopping.yahoo.co.jp/review/item/list?page_key=10022678&store_id=kurosu'),
...
('furminator-deshedding','長毛の中型雑種犬','medium','long','shedding skin caution','長毛で抜け毛の多い中型雑種犬に使い、かなりの毛を回収できた一方、毛量が少ない部分では皮膚へ強く当てないよう浮かし気味に使った体験。','public_buyer_review_summary','https://shopping.yahoo.co.jp/review/item/list/2/?page_key=10022678&store_id=kurosu'),
